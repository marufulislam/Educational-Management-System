                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_academic_effects";
                                ...
                                <tr>
                                    ...
                                    <td><?php
									if($row['information_type'] == 1){echo "Library Management";}else if($row['information_type'] == 2){echo "Educational Effects";} else if($row['information_type'] == 3){echo "Attendance Report";} else if($row['information_type'] == 4){echo "Accounts Report";}
									
									 ?></td>
                                    <td><?php echo $row['effects_details']?></td>
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_academic_effects WHERE id='$Editid';";
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_academic_effects WHERE id='".$Deleteid."'";
                                 ...
                                 <!---------------------->
                                  <div class="form-group">
                                	...
                                	<div class="col-md-9">
                                        ...
                                        <option value="1" <?php if(@$rs_view['information_type'] == 1) echo "selected='selected'" ;?>>Library Management</option>
                                        <option value="2" <?php if(@$rs_view['information_type'] == 2) echo "selected='selected'" ;?>>Educational Effects</option>
                                        <option value="3" <?php if(@$rs_view['information_type'] == 3) echo "selected='selected'" ;?>>Attendance Report</option>
                                        <option value="4" <?php if(@$rs_view['information_type'] == 4) echo "selected='selected'" ;?>>Accounts Report</option>
                             ...
                             <div class="col-md-9">
                                 <textarea rows="4" cols="20" id="effects_details" class="form-control required ckeditor" name="effects_details"><?php if (isset($rs_view["effects_details"])) echo $rs_view["effects_details"]; ?></textarea>
                                    </div>
                                </div>  
