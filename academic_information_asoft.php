                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_academic_information";
                                ...
                                <tr>
                                    ...
                                    <td><?php
									 ...
									 if($row['information_type'] == 1) echo "Academic Calender" ;
									 else if($row['information_type'] == 2) echo "Year Holidays List";
									 else if($row['information_type'] == 3) echo "Class Wise Routine";
									 else if($row['information_type'] == 4) echo "Exam Routine";
									 else if($row['information_type'] == 5) echo "Department List";
									 else if($row['information_type'] == 6) echo "Academic Rules & Regulation";
									 else if($row['information_type'] == 7) echo "List of 3rd & 4th class stuff";
									 else if($row['information_type'] == 8) echo "TC & Testimonial";
									 else if($row['information_type'] == 9) echo "Oppurtunities";
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_academic_information WHERE id='$Editid';";
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_academic_information WHERE id='".$Deleteid."'";
                                 ...
                                 <!---------------------->
                                  <div class="form-group">
                                	...
                                	<div class="col-md-9">
                                        ...
                                        <option value="2" <?php if(@$rs_view['information_type'] == 2) echo "selected='selected'" ;?>>Year Holidays List</option>
                                        <option value="3" <?php if(@$rs_view['information_type'] == 3) echo "selected='selected'" ;?>>Class Wise Routine</option>
                                        <option value="4" <?php if(@$rs_view['information_type'] == 4) echo "selected='selected'" ;?>>Exam Routine</option>
                                        <option value="5" <?php if(@$rs_view['information_type'] == 5) echo "selected='selected'" ;?>>Department List</option>
                                        <option value="6" <?php if(@$rs_view['information_type'] == 6) echo "selected='selected'" ;?>>Academic Rules & Regulation</option>
                                        <option value="7" <?php if(@$rs_view['information_type'] == 7) echo "selected='selected'" ;?>>List of 3rd & 4th class stuff</option>
                                        <option value="8" <?php if(@$rs_view['information_type'] == 8) echo "selected='selected'" ;?>>TC & Testimonial</option>
                                        <option value="9" <?php if(@$rs_view['information_type'] == 9) echo "selected='selected'" ;?>>Oppurtunities</option>
                             ...
                             <div class="col-md-9">
                                 <textarea rows="4" cols="20" id="about_description" class="form-control required ckeditor" name="about_description"><?php if (isset($rs_view["academic_details"])) echo $rs_view["academic_details"]; ?></textarea>
                                    </div>
                                </div>  
