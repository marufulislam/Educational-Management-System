                                ...
                                <!---------------------->
                                   ...
                                   <!--/span-->
                                   	<div class="col-md-2">
                                          <div class="form-group">
                                           <label>Section</label>
                                            <select multiple="" id="tbl_section" class="form-control span6 required" name="section_name">
                                   ...
                                   <!--/span-->
                                     ...
                                     <!-- <select multiple="" id="tbl_shift" class="form-control span6 required" name="shift_name">
                                         ...
                                         <select multiple="" id="tbl_term" class="form-control span6 required" name="term_name" onchange="change_exam_box(this.id,'tbl_term_sector','tbl_term_sector')">
                                     ...
                                     <div class="col-md-3">
                                      <div class="form-group">
                                      <label>Exam</label>
                                     <select multiple="" id="tbl_term_sector" class="form-control span6 required" name="exam_name">
                                                <option value="">---Select an option---</option>
                                     </select>    
                                       </div>
                                     </div>
                                ...
                                <div class="form-actions right"><!--Begin form-actions-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            ?>
                                                <button type="submit" class="btn green" name="temp" id="idsubmitData" value="Add"><i class="icon-plus"></i>&nbsp;Print</button>
...
var change_exam_box = function(id,itemTobeloaded,tbl){
	var vl = $("#"+id).val();
	if(vl == ''){
		$('#'+itemTobeloaded+' option:not(:first)').remove().end();
	}else{
