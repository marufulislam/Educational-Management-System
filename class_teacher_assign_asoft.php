                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_class_teacher_assign";
                                ...
                                <tr>
                                    ...
                                    <td><?php
										$class_name = mysql_query("SELECT `class_name` FROM tbl_class WHERE class_id='".$row['class_id']."'") or die(mysql_error());
										$rw_class = mysql_fetch_assoc($class_name);
									 	echo $rw_class['class_name'];
									 
									 ?></td>
                                    <td><?php
										$section_name = mysql_query("SELECT `section_name` FROM tbl_section WHERE section_id='".$row['section_id']."'") or die(mysql_error());
										$rw_section = mysql_fetch_assoc($section_name);
									 	echo $rw_section['section_name'];

									 ?></td>
                                    <td><?php
										$teacher_name = mysql_query("SELECT `teacher_name` FROM tbl_teacher_registration WHERE teacher_id='".$row['teacher_id']."'") or die(mysql_error());
										$rw_teacher = mysql_fetch_assoc($teacher_name);
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_class_teacher_assign WHERE id='$Editid';";
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_class_teacher_assign WHERE id='".$Deleteid."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                      <select id="class_id" class="form-control span6 required" name="class_id" onchange="change_select_box(this.id,'tbl_section','tbl_section')">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <select id="tbl_section" class="form-control span6 required" name="section_id">
                                            <option value="">---Select an option---</option>
                                       </select>
                                    </div>
                                </div>
                                ...
                                <!---------------------->
                                <div class="form-group">
                                    <label class="control-label col-md-3">Teachher Name</label>
                                    <div class="col-md-9">
