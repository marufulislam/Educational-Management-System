                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_exam_routine";
                                ...
                                <tr>
									...
									$qry_shift=mysql_query("SELECT `shift_name` FROM `tbl_shift` WHERE `shift_id` = '".$row['shift_id']."'") or die(mysql_error());
									 ...
									 ?></td>
                                    <td><?php echo $row['exm_date']?></td>
                                    <td><?php echo $row['day'];?></td>
                                    
                                    <td><?php
									$qry_subject=mysql_query("SELECT `subject_name` FROM `tbl_subject` WHERE `subject_id` = '".$row['subject_id']."'") or die(mysql_error());
									  $row_subject = mysql_fetch_array($qry_subject);
                                   ...
                                   <div class="col-md-4">
                                      <div class="form-group">
                                       <label>Exam Date</label>
                                          <input type="text" id="exm_date" class="form-control required form-control-inline date-picker voucher_date" name="exm_date" 
                                        value="<?php if (isset($rs_view["exm_date"])) echo $rs_view["exm_date"]; ?>"  readonly="readonly"/>
                                      </div>
                                   </div>
                                   <!--/span-->
                                   <div class="col-md-4">
                                ...
                                <div class="row">
                                 <div class="col-md-12">
                                   <div class="col-md-3">
                                      <div class="form-group">
                                       <label>Teacher`s Name</label>
                                         <input type="text" class="form-control" placeholder="Teachers name" name="teacher_name" id="teacher_name" value="<?php if (isset($rs_view["teachers_name"])) echo $rs_view["teachers_name"]; ?>"/>
                                      </div>
                                   </div>
                                   <!--/span-->
                                   <div class="col-md-3">
                                   ...
                                   <div class="col-md-3">
                                      <div class="form-group">
                                      <label>Room No</label>
                                    	<input type="text" class="form-control" placeholder="Room No" name="room_number" id="room_number" value="<?php if (isset($rs_view["room_number"])) echo $rs_view["room_number"]; ?>"/>
                                       </div>
                                     </div>
                                     </div>
                                    </div>
