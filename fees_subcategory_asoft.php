                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_fee_sub_category";
                                $qry_user_admin = mysql_query($sql_user_admin);
                                while($row = mysql_fetch_array($qry_user_admin)){
									$pk = $row['fee_sub_category_id'];
                                ?>
                                <tr>
                                    <td><input type="checkbox" class="checkboxes" value="1" /></td>
                                    <td><?php
									 
									 $qry_class=mysql_query("SELECT `class_name` FROM tbl_class WHERE `class_id`='".$row['student_class']."'") or die(mysql_error());
									 $rw_class=mysql_fetch_array($qry_class);
									 echo $rw_class['class_name'];
									 ?></td>
                                    <td><?php
									$qry_cat=mysql_query("SELECT `fee_category_name` FROM tbl_fee_category WHERE `fee_category_id`='".$row['fee_category_id']."'") or die(mysql_error());
									$rw_cat=mysql_fetch_array($qry_cat);
									
									 echo $rw_cat['fee_category_name'];
									 
									 ?></td>
                                    
                                    <td><?php echo $row['fee_sub_category_name']?></td>
                                    <td><?php echo $row['fee_sub_category_price'];?></td>
                                    <td>
                ...
                <?php
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_fee_sub_category WHERE fee_sub_category_id='$Editid';";
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM news_and_events WHERE id='".$Deleteid."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                      <select id="fee_category_id" class="form-control span6 required" name="fee_category_id">
                                          
                                              <?php 
                                               $rs = mysql_query("SELECT * FROM tbl_fee_category ORDER BY fee_category_id ASC");
                                                while($obj = mysql_fetch_assoc($rs)) {
                                                  echo "<option value = '".$obj['fee_category_id']."'";
                                                  if(@$rs_view['fee_category_id'] == $obj['fee_category_id']) echo "selected='selected'" ; 
                                                    echo ">".$obj['fee_category_name']."</option>";          
                                                } 
                                                ?>
                                 ...
                                 <!---------------------->
                                <div class="form-group">
                                    <label class="control-label col-md-3">Subcategory Name</label>
                                    <div class="col-md-9">
                                        <input type="text" id="fee_sub_category_name" class="form-control required" name="fee_sub_category_name" 
                                        value="<?php if (isset($rs_view["fee_sub_category_name"])) echo $rs_view["fee_sub_category_name"]; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="fee_sub_category_price" class="form-control required" name="fee_sub_category_price" 
                                        value="<?php if (isset($rs_view["fee_sub_category_price"])) echo $rs_view["fee_sub_category_price"]; ?>"/>
                                    </div>
                                </div>
