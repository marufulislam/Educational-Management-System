                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="submit/grade_assign_edit_submit.php" method="POST" class="form-horizontal form-bordered form-label-stripped" id="form_sample_1">
                                ...
                                <div class="row">
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <label>Subject</label>
                                    	<select id="tbl_subject" class="form-control span6" name="subject_id">
                                        	<?php
                                                if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
                                                $rs = mysql_query("SELECT * FROM tbl_subject WHERE subject_id='".$rs_view['subject_id']."'");
                                                $obj = mysql_fetch_assoc($rs);
                                                  echo "<option value = '".$obj['subject_id']."'"; echo "selected='selected'" ; 
                                   ...
                                   <!--/span-->
                                    ...
                                    <!---------------------->
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Grade From</label>
                                        <div class="col-md-9">
                                        <input type="text" id="grade_from" class="form-control required" name="grade_from" 
                                            value="<?php if (isset($rs_view["grade_from"])) echo $rs_view["grade_from"]; ?>"/>
                                           
                                        </div>
                                    </div>
                                     <!---------------------->
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Grade To</label>
                                        <div class="col-md-9">
                                        <input type="text" id="grade_to" class="form-control required" name="grade_to" 
                                            value="<?php if (isset($rs_view["grade_to"])) echo $rs_view["grade_to"]; ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                        <input type="text" id="grade" class="form-control required" name="grade" 
                                            value="<?php if (isset($rs_view["grade"])) echo $rs_view["grade"]; ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                        <input type="text" id="gpa_" class="form-control required" name="gpa_" 
                                            value="<?php if (isset($rs_view["gpa"])) echo $rs_view["gpa"]; ?>"/>
