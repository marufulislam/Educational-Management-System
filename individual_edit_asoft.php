...
function getScriptPage(div_id,content_id)
	...
	//	content = document.getElementById(content_id).value;
		var dataString = 'class_name='+jQuery('#class_name').val()+'&section_name='+jQuery('#tbl_section').val()+'&group_name='+jQuery('#tbl_group').val()+'&shift_name='+jQuery('#tbl_shift').val()+'&student_name='+jQuery('#tbl_student_info').val()+'&term_name='+jQuery('#term_name').val()+'&exam_year='+jQuery('#exam_year').val();
		//http.open("GET", "req_commission_report.php?" +dataString, true);
		//http.onreadystatechange = handleHttpResponse;
		//http.send(null);
		$( "#order").load( "student_marks_edit.php?" +dataString, function() {
			  //alert( dataString );
