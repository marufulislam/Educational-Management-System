                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_notice";
                                ...
                                <tr>
                                    ...
                                    <td><?php if($row['notice_type'] == 1) {echo "General Notice";} else {echo "Admission Notice";}?></td>
                                    <td><?php echo $row['notice_heading']?></td>
                                    <td><?php echo $row['notice_details']?></td>
                                    <td><?php echo $row['notice_attachment'];?></td>
                                    <td>
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_notice WHERE notice_id='$Editid';";
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_notice WHERE notice_id='".$Deleteid."'";
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Notice Type</label>
                                    <div class="col-md-9">
                                         <select id="notice_type" class="form-control span6 required" name="notice_type">
                                          <option value="">Select an option</option>
                                          <option value="1" <?php if(@$rs_view['notice_type'] == 1) echo "selected='selected'" ;?>>General Notice</option>
                                          <option value="2" <?php if(@$rs_view['notice_type'] == 2) echo "selected='selected'" ;?>>Admission Notice</option>
                                 ...
                                 <!---------------------->
                                <div class="form-group">
                                    <label class="control-label col-md-3">Notice Heading</label>
                                    <div class="col-md-9">
                                     <input type="text" id="notice_heading" class="form-control required " name="notice_heading" 
                                      value="<?php if (isset($rs_view["notice_heading"])) echo $rs_view["notice_heading"]; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                     <textarea rows="4" cols="20" id="notice_details" class="form-control ckeditor" name="notice_details"><?php if (isset($rs_view["notice_details"])) echo $rs_view["notice_details"]; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="publish_date" class="form-control required form-control-inline date-picker voucher_date" name="publish_date" 
                                        value="<?php if (isset($rs_view["publish_date"])) echo $rs_view["publish_date"]; ?>"  readonly="readonly"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if(@$_REQUEST['temp']=="Save"||@$_REQUEST['temp']=="View"){
                                    @$path = '../file/notice/'.@$rs_view["notice_attachment"];
                                    if(@$rs_view["notice_attachment"] != "" && file_exists($path)==true)
                                    {
                                    ?>
                                    <p>
                                     <button type="button" class="btn"  id="btn-<?php  echo $Editid;?>">Uploaded File :&nbsp;&nbsp; <strong> <?php echo $rs_view["notice_attachment"];?></strong> &nbsp;&nbsp;&nbsp;<a href="javascript:void()" class=" delete" id="train_file-<?php  echo $Editid;?>"><i class="icon-trash"></i></a></button>
                                    <span id="deleteLoader">&nbsp;</span>
...
<script src="assets/scripts/fileUpload.js"></script> 
