                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tr>
									...
									$rw_teacher = mysql_fetch_assoc($qry_teacher);
                                     ...
                                     <td><?php
									   $qry_teacher = mysql_query("SELECT `teacher_name` FROM tbl_teacher_registration WHERE `teacher_id`='".$row['teacher_id']."'") or die(mysql_error());
									   $row_teacher = mysql_fetch_array($qry_teacher);
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_teacher_salary WHERE teacher_salary_id='$Editid';";
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_teacher_salary WHERE teacher_salary_id='".$Deleteid."'";
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Teacher or Staff salary</label>
                                    <div class="col-md-9">
                                        <select id="teacher_id" class="form-control span6 required" name="teacher_id">
                                          <option value="">Select an option</option>
                                              <?php 
                                              $rs = mysql_query("SELECT * FROM tbl_teacher_registration ORDER BY teacher_id ASC");
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="basic_salary" class="form-control required" name="basic_salary" 
                                        value="<?php if (isset($rs_view["basic_salary"])) echo $rs_view["basic_salary"]; ?>" onkeyup="totalsalary()"/>
                                    </div>
                                </div>
                                 <!---------------------->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="house_rent" class="form-control required" name="house_rent" 
                                        value="<?php if (isset($rs_view["house_rent"])) echo $rs_view["house_rent"]; ?>" onkeyup="totalsalary()"/>
                                    </div>
                                </div>
                                 <!---------------------->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="medical" class="form-control required" name="medical" 
                                        value="<?php if (isset($rs_view["medical"])) echo $rs_view["medical"]; ?>" onkeyup="totalsalary()"/>
                                    </div>
                                </div>
                                 <!---------------------->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="bonus" class="form-control required" name="bonus" 
                                        value="<?php if (isset($rs_view["bonus"])) echo $rs_view["bonus"]; ?>" onkeyup="totalsalary()"/>
                                    </div>
                                </div>
                                 <!---------------------->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="others" class="form-control required" name="others" 
                                        value="<?php if (isset($rs_view["others"])) echo $rs_view["others"]; ?>" onkeyup="totalsalary()"/>
                                    </div>
                                </div>
                                 <!---------------------->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        value="<?php if (isset($rs_view["total"])) echo $rs_view["total"]; ?>"/>
                                    </div>
                                </div>
...
function totalsalary(){
    var field1=document.getElementById('basic_salary');
    var field2=document.getElementById('house_rent');
    var field3=document.getElementById('medical');
    var field4=document.getElementById('bonus');
    var field5=document.getElementById('others');

    var result=document.getElementById('total');

    if(field1.value=="" || field1.value!=parseFloat(field1.value)) field1.value=0;
    if(field2.value=="" || field2.value!=parseFloat(field2.value)) field2.value=0;
    if(field3.value=="" || field3.value!=parseFloat(field3.value)) field3.value=0;
    if(field4.value=="" || field4.value!=parseFloat(field4.value)) field4.value=0;
    if(field5.value=="" || field5.value!=parseFloat(field5.value)) field5.value=0;
    result.value=0;

    result.value=parseInt(result.value);
    result.value=parseInt(result.value)+parseInt(field1.value)+parseInt(field2.value)+parseInt(field3.value)+parseInt(field4.value)+parseInt(field5.value);
}
</script>
