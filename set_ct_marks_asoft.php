                ...
                <div class="tab-pane active" id="tab_0">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_ct_marks WHERE ct_marks_id='$Editid';";
                                ...
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_ct_marks WHERE ct_marks_id='".$Deleteid."'";
                                 ...
                                 <div class="col-md-12">
                                   <div class="col-md-1">
                                      <div class="form-group">
                                       <label>Class</label>
                                       <select multiple="" id="class_name" class="form-control span6 required" name="class_name" onchange="change_sction_box(this.id,'tbl_section','tbl_section')">
                                   ...
                                   <div class="col-md-1">
                                          <div class="form-group">
                                           <label>Section</label>
                                            <select multiple="" id="tbl_section" class="form-control span6 required" name="section_name" onchange="change_subject_box(this.id,'tbl_subject','tbl_subject')">
                                   ...
                                   <div class="col-md-3">
                                      ...
                                      <select multiple="" id="tbl_subject" class="form-control span6 required" name="subject_name">
                                            <option value="">---Select an option---</option>
                                       </select>
...
var submit_refered_commission = function(){

		  var dataString = jQuery('#ct_marks_frm').serialize()+'&temp='+jQuery("#ct_marks_frm-comment").val();
		
        //var dataString = jQuery('#test_name_insert').serialize()+'&temp='+jQuery("#idsubmitDataTestName").val();
		//alert(dataString);
        jQuery.ajax({
            type:'POST', 
            url: 'submit/set_ct_marks_submit.php',
			data: dataString,
			cache: false,
            success: function(response) {
                //alert(response);
                jQuery('.ct_term').html(response);
...
<script>
  ...
  function getScriptPage(div_id,content_id)
	...
	//	content = document.getElementById(content_id).value;
		var dataString = 'class_name='+jQuery('#class_name').val()+'&section_name='+jQuery('#tbl_section').val()+'&group_name='+jQuery('#tbl_group').val()+'&shift_name='+jQuery('#tbl_shift').val()+'&subject_name='+jQuery('#tbl_subject').val()+'&term_name='+jQuery('#term_name').val()+'&exam_year='+jQuery('#exam_year').val();
		//http.open("GET", "req_commission_report.php?" +dataString, true);
		//http.onreadystatechange = handleHttpResponse;
		//http.send(null);
		
		
		$( "#order").load( "req_student_ctmarks.php?" +dataString, function() {
			  //alert( dataString );
