                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_stuff_recruitment";
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_stuff_recruitment WHERE id='$Editid';";
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_stuff_recruitment WHERE id='".$Deleteid."'";
                                ...
                                <div class="alert alert-success display-hide form_success">
                                 ...
                                 <!---------------------->
                                  <div class="form-group">
                                	...
                                	<div class="col-md-9">
                                  		 <input type="text" id="heading" class="form-control required" name="heading" 
                                        value="<?php if (isset($rs_view["heading"])) echo $rs_view["heading"]; ?>"/>
                                	</div>
                                 </div>
                             ...
                             <div class="col-md-9">
                                 <textarea rows="4" cols="20" id="details" class="form-control required ckeditor" name="details"><?php if (isset($rs_view["details"])) echo $rs_view["details"]; ?></textarea>
                                    </div>
                                </div>  
