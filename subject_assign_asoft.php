                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
											...
											$sql_marks_table = "DELETE FROM tbl_full_marks WHERE subject_name='".$Deleteid."'";
                                            $rs_marks_delete=mysql_query($sql_marks_table);
											
											$sql_grade_table = "DELETE FROM tbl_grade_assign WHERE subject_id='".$Deleteid."'";
                                            $rs_grade_delete=mysql_query($sql_grade_table);
											
                                            $sql_delete="DELETE FROM tbl_subject WHERE subject_id='".$Deleteid."'";
                                ...
                                <div id="event_cloning" >
                                    <div id="event_cloning_template" class="form-group">
                                         <label for="event_cloning_#index#_ename" class="control-label col-md-3 "></label>
                                            <div class="col-md-9">
                                                <div class="col-md-3">
													<input type="text" id="input_cloning_subject_name_#index#_input" class="form-control" name="subject_name[#index#]" placeholder="Subject Name" value=""/>
                                                </div>
                                                <div class="col-md-2">
													<input type="text" id="input_cloning_subject_code_#index#_input" class="form-control" name="subject_code[#index#]" placeholder="Subject Code" value=""/>
                                                </div>
                                                <div class="col-md-2">
                                                     <input type="text" id="input_cloning_pass_marks_under_#index#_input" class="form-control" name="pass_marks_under[#index#]" placeholder="Pass Marks(under Nine)" value=""/>
                                                 </div>
                                                 <div class="col-md-2">
                                                     <input type="text" id="input_cloning_cr_pass_marks_#index#_input" class="form-control" name="cr_pass_marks[#index#]" placeholder="Creative Pass Marks" value=""/>
                                                </div>
                                                 <div class="col-md-2">
                                                     <input type="text" id="input_cloning_ob_pass_marks_#index#_input" class="form-control" name="ob_pass_marks[#index#]" placeholder="Obj Pass Marks" value=""/>
                                                </div>
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                <thead class="flip-content">
                                    <tr>
                                       ...
                                       <th>Subject Name</th>
                                       <th>Subject Code</th>
                                       <th>Pass Marks(under Nine)</th>
                                       <th>Creative Pass Marks</th>
                                       <th>Objective Pass Marks</th>
                                       <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_subject";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['pass_marks_under']?></td>
                                   <td><?php echo $row['cr_pass_marks']?></td>
                                   <td><?php echo $row['ob_pass_marks']?></td>
                                    <td>
                                    ...
                                    <?php if(@$row_access_acs[1] == 'Edit') {?>
                                        ...
                                        href="<?php echo urlroute('subject_assign_edit'); ?>&Editid=<?php echo $pk;?>&temp=Save"
