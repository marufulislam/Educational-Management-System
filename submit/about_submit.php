...
if($temp == "Add"){
		...
		$sql = "INSERT INTO `tbl_about`(`school_id`, `information_type`, `about_details`,  `status`, `created_on`) VALUES ('".$user_id."','".$information_type."','".$about_description."','".$status."','".$datetime."')";
...
if($temp == "Update"){
	...
	$sql_delete="DELETE FROM tbl_about WHERE about_id='".$Editid."'";
	$rs_delete=mysql_query($sql_delete);
		...
		$sql = "INSERT INTO `tbl_about`(`about_id`, `school_id`, `information_type`, `about_details`,  `status`, `created_on`) VALUES ('$Editid', '".$user_id."','".$information_type."','".$about_description."','".$status."','".$datetime."')";
		$qry = mysql_query($sql) or die('Error in insertion : ' . mysql_error($sql));
