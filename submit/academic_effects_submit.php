...
$effects_details = escape(isset($_POST['effects_details'])) ?  $_POST['effects_details'] : '';
...
if($temp == "Add"){
		...
		$sql = "INSERT INTO `tbl_academic_effects`(`school_id`, `information_type`, `effects_details`,  `status`, `created_on`) VALUES ('".$user_id."','".$information_type."','".$effects_details."','".$status."','".$datetime."')";
...
if($temp == "Update"){
	...
	$sql_delete="DELETE FROM tbl_academic_effects WHERE id='".$Editid."'";
	$rs_delete=mysql_query($sql_delete);
		...
		$sql = "INSERT INTO `tbl_academic_effects`(`id`, `school_id`, `information_type`, `effects_details`,  `status`, `created_on`) VALUES ('$Editid', '".$user_id."','".$information_type."','".$effects_details."','".$status."','".$datetime."')";
		$qry = mysql_query($sql) or die('Error in insertion : ' . mysql_error($sql));
