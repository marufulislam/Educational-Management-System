...
if($temp == "Add"){
		...
		$sql = "INSERT INTO `tbl_student_routine`(`class_id`, `section_id`, `shift_id`, `day`, `start_time`, `end_time`, `subject_id`) VALUES ('".$class_name."','".$section_name."','".$student_shift."','".$day."','".$start_time."','".$end_time."','".$subject."')";
...
if($temp == "Update"){
	...
	$sql_delete="DELETE FROM tbl_student_routine WHERE id='".$Editid."'";
	$rs_delete=mysql_query($sql_delete); 
	
	
	
	
		$sql = "INSERT INTO `tbl_student_routine`(`id`, `class_id`, `section_id`, `shift_id`, `day`, `start_time`, `end_time`, `subject_id`) VALUES ('$Editid', '".$class_name."','".$section_name."','".$student_shift."','".$day."','".$start_time."','".$end_time."','".$subject."')";
		$qry = mysql_query($sql) or die('Error in insertion : ' . mysql_error($sql));
