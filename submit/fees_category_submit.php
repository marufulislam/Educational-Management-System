...
$fee_category_name = escape(isset($_POST['fee_category_name'])) ?  $_POST['fee_category_name'] : '';
...
if($temp == "Add"){
	...
	$qry_having = mysql_query("SELECT * FROM `tbl_fee_category` WHERE fee_category_name='".$fee_category_name."'");
	if(mysql_num_rows($qry_having) == 0){
	
		$sql = "INSERT INTO `tbl_fee_category`(`school_id`, `fee_category_name`, `created_on`) VALUES ('".$user_id."','".$fee_category_name."','".$datetime."')";
...
if($temp == "Update"){
	...
	$sql_delete="DELETE FROM tbl_fee_category WHERE fee_category_id='".$Editid."'";
