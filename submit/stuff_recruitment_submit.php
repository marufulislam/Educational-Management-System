...
$heading = escape(isset($_POST['heading'])) ?  $_POST['heading'] : '';
$details = escape(isset($_POST['details'])) ?  $_POST['details'] : '';
...
if($temp == "Add"){
		...
		$sql = "INSERT INTO `tbl_stuff_recruitment`(`school_id`, `heading`, `details`,  `status`, `created_on`) VALUES ('".$user_id."','".$heading."','".$details."','".$status."','".$datetime."')";
...
if($temp == "Update"){
	...
	$sql_delete="DELETE FROM tbl_stuff_recruitment WHERE id='".$Editid."'";
	$rs_delete=mysql_query($sql_delete);
		...
		$sql = "INSERT INTO `tbl_stuff_recruitment`(`id`, `school_id`, `heading`, `details`,  `status`, `created_on`) VALUES ('$Editid', '".$user_id."','".$heading."','".$details."','".$status."','".$datetime."')";
		$qry = mysql_query($sql) or die('Error in insertion : ' . mysql_error($sql));
