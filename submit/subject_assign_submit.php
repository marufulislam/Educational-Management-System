...
if($temp == "Add"){
		...
		foreach($subject_name as $key=>$value){
				$i++;
			$sql= "INSERT INTO `tbl_subject`(`school_id`, `class_id`, `subject_name`,`subject_code`, `pass_marks_under`, `cr_pass_marks`, `ob_pass_marks`, `status`, `created_on`) VALUES ('".$user_id."','".$class_id."','".$value."','".$subject_code[$key]."','".$pass_marks_under[$key]."','".$cr_pass_marks[$key]."','".$ob_pass_marks[$key]."','".$status."','".$datetime."')";
...
if($temp == "Update"){
	...
	$rs_delete=mysql_query($sql_delete); 
		...
		$sql = "INSERT INTO `tbl_subject`(`subject_id`, `school_id`, `subject_name`,`subject_code`,`pass_marks_under`, `cr_pass_marks`, `ob_pass_marks`, `status`, `created_on`) VALUES ('$Editid','".$user_id."','".$subject_name."', '".$subject_code."', '".$pass_marks_under."', '".$cr_pass_marks."', '".$ob_pass_marks."', '".$status."', '".$datetime."')";
