                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM teachers_routine";
                                ...
                                <tr>
									...
									$qry_subject=mysql_query("SELECT `subject_name` FROM `tbl_subject` WHERE `subject_id` = '".$row['subject_id']."'") or die(mysql_error());
									  $row_teacher = mysql_fetch_array($qry_subject);
									  echo $row_teacher['subject_name'];
                                ...
                                <div class="row">
                                 <div class="col-md-12">
                                   ...
                                   <div class="col-md-3">
                                      <div class="form-group">
                                       <label>Teacher</label>
                                         <select id="teacher_name" class="form-control" name="teacher_name">
                                         	<option value="">Select a day</option>
                                              <?php 
