                	...
                	<div class="portlet box blue ">
                        ...
                        <div class="portlet-body  flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-condensed flip-content" id="sample_1">
                                ...
                                <tbody>
                                <?php
                                $sql_user_admin = "SELECT * FROM tbl_term";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['term_name']?></td>
                                     <td align="center"><span id="like-loader1<?php  echo $pk;?>">&nbsp;</span> <span id="like-panel-for-product-publish<?php  echo $pk;?>">
								    	<?php if($isPublish == 1){?>
                ...
                <div class="tab-pane <?php if(@$_REQUEST['temp']=="Save" || @$_REQUEST['temp']=="View") {echo "active";} else{echo "";}?>" id="tab_1">
					...
					if(isset($_REQUEST['temp'])){
						if($_REQUEST['temp']=="Save" || $_REQUEST['temp']=="View"){
							...
							$sql_view = "SELECT * FROM tbl_term WHERE term_id='$Editid';";
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body"><!--Begin form-body-->
                                <div class="form_result">
                                    ...
                                    if(isset($_REQUEST['temp'])){
                                        if($_REQUEST['temp']=="Delete"){
                                            ...
                                            $sql_delete="DELETE FROM tbl_term WHERE term_id='".$Deleteid."'";
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="term_name" class="form-control required" name="term_name" 
                                        value="<?php if (isset($rs_view["term_name"])) echo $rs_view["term_name"]; ?>"/>
                                    </div>
                                </div>
...
$('.active_product_publish').livequery("click",function(e){	
			...
			$.post("active_final.php?id="+getID+"&set="+active, function(response){
				$('#like-panel-for-product-publish'+getID).html('<a href="javascript: void(0)" id="deactive_product_publish-'+getID+'" class="deactive_product_publish btn default"><span class="label label-sm label label-sm label-danger">No</span></a>');
...
$('.deactive_product_publish').livequery("click",function(e){
			...
			$("#like-loader1"+getID).html('<img src="assets/img/input-spinner.gif" alt="" />');
			$.post("active_final.php?id="+getID+"&set="+deactive, function(response){
				$('#like-panel-for-product-publish'+getID).html('<a href="javascript: void(0)" id="active_product_publish-'+getID+'" class="active_product_publish btn default"><span class="label label-sm label label-sm label-success">Yes</span></a>');
				$("#like-loader1"+getID).html('');
			});
		});
</script>
